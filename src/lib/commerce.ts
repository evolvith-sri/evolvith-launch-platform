...
export const PRODUCT_COMMERCE_MAPPINGS: Record<string, ProductCommerceMapping> = {
  ...
  'pipe-os-01': {
    ...
    currency: 'USD',
    licenseType: 'One-Time Perpetual Commercial License',
    dodoProductId: 'pdt_0NlvPIPE01OSWaterfall',
    commerceAvailability: 'READY_FOR_COMMERCE',
    fulfillmentType: 'DIGITAL_RUNTIME_PACKAGE',
  ...
  'seo-audit-os-01': {
    ...
    currency: 'USD',
    licenseType: 'One-Time Perpetual Commercial License',
    dodoProductId: 'pdt_0NlvSEO01OSCrawler',
    commerceAvailability: 'READY_FOR_COMMERCE',
    fulfillmentType: 'DIGITAL_RUNTIME_PACKAGE',
  ...
  'onboard-os-01': {
    ...
    currency: 'USD',
    licenseType: 'One-Time Perpetual Commercial License',
    dodoProductId: 'pdt_0NlvONBOARD01OSIntake',
    commerceAvailability: 'READY_FOR_COMMERCE',
    fulfillmentType: 'DIGITAL_RUNTIME_PACKAGE',
  ...
  'prompt-qa-os-01': {
    ...
    currency: 'USD',
    licenseType: 'One-Time Perpetual Commercial License',
    dodoProductId: 'pdt_0NlvPROMPT01OSWorkbench',
    commerceAvailability: 'READY_FOR_COMMERCE',
    fulfillmentType: 'DIGITAL_RUNTIME_PACKAGE',
  ...
  'doc-portal-os-01': {
    ...
    currency: 'USD',
    licenseType: 'One-Time Perpetual Commercial License',
    dodoProductId: 'pdt_0NlvDOC01OSPortalGen',
    commerceAvailability: 'READY_FOR_COMMERCE',
    fulfillmentType: 'DIGITAL_RUNTIME_PACKAGE',
